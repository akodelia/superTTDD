...
public class RegistroProducto {
	...
	public RegistroProducto(CategoriaProducto categoria, MarcaProducto marca, String nombre, Double precio) {
		this.marca=marca;
	...
	public boolean equals (Object obj) {
		...
		return (registro != null) && (this.categoria == registro.categoria) &&
